...
class Favorregions
{
  public:
     ...
     */
    explicit Favorregions(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Favorregions(const Json::Value &pJson) noexcept(false);
     ...
     */
    Favorregions(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    Favorregions() = default;
  ...
  private:
    friend drogon::orm::Mapper<Favorregions>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Favorregions>;
#endif
