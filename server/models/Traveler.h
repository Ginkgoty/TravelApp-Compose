...
class Traveler
{
  public:
     ...
     */
    explicit Traveler(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Traveler(const Json::Value &pJson) noexcept(false);
     ...
     */
    Traveler(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Traveler>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Traveler>;
#endif
