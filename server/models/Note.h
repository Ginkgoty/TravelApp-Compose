...
class Note
{
  public:
     ...
     */
    explicit Note(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
    ...
    /**  For column img  */
    ///Get the value of the column img, returns the default value if the column is null
    const std::string &getValueOfImg() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getImg() const noexcept;
    ///Set the value of the column img
    void setImg(const std::string &pImg) noexcept;
    void setImg(std::string &&pImg) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Note>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Note>;
#endif
    ...
    std::shared_ptr<std::string> img_;
