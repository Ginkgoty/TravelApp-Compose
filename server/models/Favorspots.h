...
class Favorspots
{
  public:
    ...
    using PrimaryKeyType = std::tuple<int32_t,int32_t>;//uid,sid
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where uid = $1 and sid = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where uid = $1 and sid = $2";
        return sql;
    }
