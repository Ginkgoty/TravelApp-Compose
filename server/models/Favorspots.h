...
class Favorspots
{
  public:
    ...
    using PrimaryKeyType = std::tuple<std::string,int32_t>;//uname,sid
     ...
     */
    explicit Favorspots(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Favorspots(const Json::Value &pJson) noexcept(false);
     ...
     */
    Favorspots(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Favorspots>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Favorspots>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where uname = $1 and sid = $2";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where uname = $1 and sid = $2";
        return sql;
    }
